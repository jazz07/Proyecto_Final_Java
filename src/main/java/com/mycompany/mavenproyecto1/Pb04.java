 ...
 * @author 1
 */
public class Pb04 extends javax.swing.JPanel {
JButton boton1= new JButton("Agregar");
   ...
   private void propiedadesTabla(){
       ...
       DefaultTableModel prop = new DefaultTableModel(null,titulos);
         prop.addRow(new Object[]{"Café Negro","10",new JLabel(new ImageIcon(getClass().getResource("/iconos-proyecto/bebidas calientes.png")) )});
         prop.addRow(new Object[]{"Cerveza","15",new JLabel(new ImageIcon(getClass().getResource("/iconos-proyecto/beer_drink_icon_146801.png")) )});
         prop.addRow(new Object[]{"Vino","100",new JLabel(new ImageIcon(getClass().getResource("/iconos-proyecto/drinks_beer_icon_146848.png")) )});
         prop.addRow(new Object[]{"Jugo de Naranja","10",new JLabel(new ImageIcon(getClass().getResource("/iconos-proyecto/iconfinder-orange-juicefood-and-restaurantorganicveganhealthy-foodvegetarianjuiceglassfooddrinkfruit-4394773_119498.png")) )});
         prop.addRow(new Object[]{"Té Caliente","10",new JLabel(new ImageIcon(getClass().getResource("/iconos-proyecto/hot-tea.png")) )});
         prop.addRow(new Object[]{"Frappes","15",new JLabel(new ImageIcon(getClass().getResource("/iconos-proyecto/take_away_coffee_to_go_icon_124562.png")) )});
         prop.addRow(new Object[]{"Chocolate Caliente","15",new JLabel(new ImageIcon(getClass().getResource("/iconos-proyecto/coffee.png")) )});
   ...
   public class imgTabla extends DefaultTableCellRenderer{
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Bebidas", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Forte", 1, 24), new java.awt.Color(0, 255, 204))); // NOI18N
